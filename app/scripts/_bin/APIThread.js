/*
*   @site           SuperSnooper
*   @function       API Thread (DEPRECATE HOPEFULLY)
*   @author         Greg Findon
...
SuperSnooper.APIThread.prototype.dataLoaded = function(_data) {
    ...
    if(this.info.itemCount < this.itemCountMax && _continue && _data.pagination && _data.pagination.next_max_id) { //this.callCount < this.callCountMax && this.itemCount < this.itemCountMax &&
